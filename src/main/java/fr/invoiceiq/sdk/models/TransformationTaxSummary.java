...
/**
 * Récapitulatif de taxe pour la transformation (utilise basisAmount).
 */
public class TransformationTaxSummary {
    ...
    public TransformationTaxSummary() {
    }
    ...
    public static class Builder {
        ...
        public TransformationTaxSummary build() {
            TransformationTaxSummary summary = new TransformationTaxSummary();
