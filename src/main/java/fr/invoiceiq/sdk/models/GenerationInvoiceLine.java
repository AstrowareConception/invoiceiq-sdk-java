...
/**
 * Ligne de facture pour la génération (utilise unitPrice).
 */
public class GenerationInvoiceLine {
    @SerializedName("id")
    private String id;
    ...
    public static class Builder {
        ...
        public GenerationInvoiceLine build() {
            GenerationInvoiceLine line = new GenerationInvoiceLine();
            line.setId(id);
            line.setName(name);
