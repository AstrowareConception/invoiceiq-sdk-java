...
/**
 * Ligne de facture pour la transformation (utilise netPrice).
 */
public class TransformationInvoiceLine {
    @SerializedName("id")
    private String id;
    ...
    public TransformationInvoiceLine() {
    }
    ...
    public static class Builder {
        ...
        public TransformationInvoiceLine build() {
            TransformationInvoiceLine line = new TransformationInvoiceLine();
            line.setId(id);
            line.setName(name);
